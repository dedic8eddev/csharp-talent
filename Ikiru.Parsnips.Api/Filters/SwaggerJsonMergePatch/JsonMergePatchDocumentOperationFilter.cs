//based on https://github.com/Morcatko/Morcatko.AspNetCore.JsonMergePatch/blob/master/src/3.0-testApp/JsonMergePatchDocumentOperationFilter.cs
...
namespace Ikiru.Parsnips.Api.Filters.SwaggerJsonMergePatch
{
		...
		public void Apply(OpenApiOperation operation, OperationFilterContext context)
		{
			...
			void CleanUpSchemas(string jsonMergePatchSchemaId)
			{
				...
				if (schemas.TryGetValue(jsonMergePatchSchemaId, out var jsonMergePatchSchema))
				{
					...
					if (contractResolverSchema.AllOf.Any())
						schemas.Remove(contractResolverSchema.AllOf.First().Reference.Id);
