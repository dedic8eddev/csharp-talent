...
using Ikiru.Parsnips.Shared.Infrastructure.DataPoolApi.Models;
using Ikiru.Parsnips.UnitTests.IdentityAdminApi;
...
namespace Ikiru.Parsnips.UnitTests.DataPoolApi
{
    public class DataPoolApiAuthTests
    {
        ...
        private const string _SCOPE = "ParsnipsDataPoolApi";
        ...
        private IDataPoolApi CreateIdentityServerApi()
        {
            ...
            var builder = services.AddDataPoolApi(configuration, b => b.AddHttpMessageHandler(() => new SimulatedTokenRequestHandler(m_GetTokenDelegate.Object)));
            builder.AddHttpMessageHandler(() => m_RequestHandler.Object); 

            return services.BuildServiceProvider().GetService<IDataPoolApi>();
        }
